...
class OneilHoffmanEnumeratorBenchmark(Observer):
    ...
    def benchmark(self):
        ...
        for requests in range(self._requests_benchmark_start, self._requests_benchmark_end + 1):
            ...
            enumerator.attach(self)
            solution = enumerator.calculate_solution()
            enumerator.detach(self)
            ...
            sheet.cell(row=row_index, column=5).value = enumerator.feasible_solutions_counter
